...
- Make definite assertions. Avoid tame, colorless, hesitating, non-committal language ([Strunk's *Elements of Style*](http://www.bartleby.com/141/index.html)).
- Simple sentences are effective. Avoid long, convoluted phrases. In technical writing, simple sentence structure enhances clarity.
- Be **consistent** in your writing style. Do not switch between different notations or conventions within one paper.
- Use on-line resources: [Strunk's *Elements of Style*](http://www.bartleby.com/141/index.html), [American Heritage Book of English Usage](http://www.bartleby.com/64/), [Webster's Dictionary and Thesaurus](http://www.m-w.com). A good book: [*Bugs in Writing*](http://www.amazon.com/exec/obidos/tg/detail/-/020137921X/).
...
See Knuth, Larrabee, and Roberts, [Mathematical Writing](http://www-cs-faculty.stanford.edu/~knuth/klr.html). Brief pointers:
...
- **Gerunds and infinitives** are not interchangeable. Use them correctly (e.g. "required the user to implement" or "required the implementation of"; "involves implementing"; "managed to implement"). See [gerunds and infinitives](http://www.iei.uiuc.edu/structure/structure1/gerinfvbs.html) and [Purdue OWL](http://owl.english.purdue.edu/handouts/grammar/g_verbals.html).
- **Compound modifiers and compound nouns** should be hyphenated to avoid ambiguity (e.g. "binary data-structure" vs "binary-data structure"). See [compounds](http://webster.commnet.edu/grammar/compounds.htm).
